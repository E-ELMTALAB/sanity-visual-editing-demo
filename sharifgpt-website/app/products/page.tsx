          ...
          <div className="lg:w-3/4">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
              ...
              <div className="space-y-3">
                {[
                  { q: "چگونه می‌توانم محصول خریداری کنم؟", a: "برای خرید محصول، آن را به سبد خرید اضافه کرده و مراحل پرداخت را طی کنید." },
                  { q: "زمان تحویل محصول چقدر است؟", a: "محصولات دیجیتال بلافاصله پس از پرداخت در دسترس شما قرار می‌گیرند." },
                  { q: "آیا امکان بازگشت وجه وجود دارد؟", a: "بله، تا 7 روز پس از خرید می‌توانید درخواست بازگشت وجه دهید." },
                  { q: "روش‌های پرداخت چه هستند؟", a: "پرداخت از طریق کارت‌های بانکی، کیف پول الکترونیک و رمزارزها امکان‌پذیر است." }
                ].map((faq, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      <h3 className="font-semibold text-gray-800 flex-1">{faq.q}</h3>
                      <svg
