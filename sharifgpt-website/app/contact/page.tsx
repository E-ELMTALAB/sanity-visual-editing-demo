      ...
      <main className="container mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
              <h2 className="text-xl font-bold text-gray-800 mb-6">فرم تماس</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="sales">فروش و خرید</option>
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 px-8 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 transform hover:scale-105"
                  >
                    ارسال پیام
                  </button>
                </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-6 border border-blue-100 shadow-sm">
              <h3 className="font-semibold text-gray-800 mb-3">چگونه می‌توانم دوره خریداری کنم؟</h3>
              <p className="text-gray-600 text-sm">
                برای خرید دوره، کافی است روی دوره مورد نظر کلیک کرده و مراحل پرداخت را طی کنید.
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-blue-100 shadow-sm">
              <h3 className="font-semibold text-gray-800 mb-3">آیا گواهینامه دریافت می‌کنم؟</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 border border-blue-100 shadow-sm">
              <h3 className="font-semibold text-gray-800 mb-3">چقدر زمان برای پاسخ نیاز است؟</h3>
              <p className="text-gray-600 text-sm">معمولاً در کمتر از 24 ساعت به پیام‌های شما پاسخ می‌دهیم.</p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-blue-100 shadow-sm">
              <h3 className="font-semibold text-gray-800 mb-3">آیا امکان بازگشت وجه وجود دارد؟</h3>
              <p className="text-gray-600 text-sm">بله، تا 7 روز پس از خرید امکان بازگشت وجه وجود دارد.</p>
            </div>
          </div>
        </div>
      </main>
