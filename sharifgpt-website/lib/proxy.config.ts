 ...
 * 
 * This file centralizes all proxy URLs for bypassing internet filtering.
 ...
 * - NEXT_PUBLIC_SANITY_CDN_PROXY_URL: URL of Sanity CDN proxy (if using separate workers)
 * - NEXT_PUBLIC_SANITY_API_PROXY_URL: URL of Sanity API proxy (if using separate workers)
 * - NEXT_PUBLIC_MEDUSA_PROXY_URL: URL of Medusa proxy (if using separate workers)
 */
...
/**
 * Get the Sanity API base URL (for the client)
