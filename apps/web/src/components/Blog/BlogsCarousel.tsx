...
export function BlogsCarousel({
  ...
  return <section className={cn("relative py-8 sm:py-10 lg:py-12 px-6 lg:px-[100px] overflow-hidden bg-transparent", className)}>
      <div className="max-w-[1400px] mx-auto relative z-10">
        <SectionHeader title="مقالات منتخب" eyebrow="آخرین مطالب بلاگ" className="mb-6" />
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            ...
            y: 0
              ...
              {posts.map((post, index) => <motion.div key={post._id} className="flex-[0_0_75%] sm:flex-[0_0_45%] md:flex-[0_0_38%] lg:flex-[0_0_24%] min-w-0" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
